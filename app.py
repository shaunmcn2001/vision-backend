#!/usr/bin/env python3
# LAWD Parcel Toolkit · 2025-07-12  (button-popup menu)

"""
• Folium map + parcels
• AgGrid table — each row has a ‘⋮’ button → pop-up menu
      Zoom | Download KML | Remove
...
if "parcels" in st.session_state:
    ...
    sty=lambda f:{"fillColor":s["fill"],
                  "color":"red" if f.get("properties",{}).get("name","") in sel_ids else s["line"],
...
""")
    ...
    # ---- per-row actions & Export-ALL (paste your existing handlers) ----
    # ...
