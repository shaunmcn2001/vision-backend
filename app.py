...
# ─── Helper: GeoDataFrame → zipped Shapefile ─────────────
def gdf_to_shp_zip(gdf: gpd.GeoDataFrame) -> bytes:
    ...
    with panel_col:
        ...
        if not df.empty:
            ...
            if b3.button("Export Selected SHP"):
                ...
                b3.download_button("⬇️ SHP", zip_bytes, "selected_parcels.zip", "application/zip")
